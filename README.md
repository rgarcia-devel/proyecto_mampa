...
1. SP: es un proceso de almacenamiento directo en el servidor de las base de datos.

2. ORM: nos permite consumir el servicio de base de datos como un objeto sin la necesidad de de hacer querys directamente.

3. un volumen en el contexto de docker se refiere a una unidad de almacenamiento, podria verse como un disco duro.

4. los services en angular sirven para el consumo de apis del backend
